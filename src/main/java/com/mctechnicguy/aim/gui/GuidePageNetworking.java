...
public class GuidePageNetworking implements ICustomManualEntry {
    ...
    public void drawLeftSidePicture(int page, @Nonnull Minecraft mc, @Nonnull GuiAIMGuide gui, float zLevel) {
        ...
        GuiAIMGuide.drawScaledTexturedQuad(gui.BgStartX + 15, gui.BgStartY + (GuiAIMGuide.BGY / 2D) - 50, 0, 512 + 225, 512, 1024, GuiAIMGuide.BGX / 2D - 30, 289 * ((GuiAIMGuide.BGX / 2D - 30) / 512D), zLevel);
